...
| `delphi_read` | Encoding-correct numbered reads (CP1252 / UTF-8±BOM detected for real); a binary `.dfm` is shown as text, the IDE's own conversion, and the answer says so |
