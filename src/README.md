...
| Project | What it is |
|---|---|
| **`DelphiLspMcp.dproj`** | **The server itself** — the Delphi IDE Remote MCP Server: 43 tools over stdio, HTTP (`--http`) or tray (`-gui`), LSP core included. What ships in every release. |
