...
`McpLinuxDesktop` is the **compiled Linux64 binary** of the desktop node
(sources: [`src_linux_desktop_node/`](../src_linux_desktop_node)). It ships in
...
sources — see the README in `src_linux_desktop_node/`.
